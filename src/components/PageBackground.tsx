...
const PAGE_CONFIGS: Record<string, Partial<PageConfig>> = {
  home: {
    ...
    vectors: [
      {
        src: images.vector12,
        className: `${V} left-0 top-1/3 w-24 md:w-45 block`,
      },
      {
        src: images.vector13,
        className: `${V} left-10 m:left-[38%] -bottom-30 m:-bottom-65 w-60 m:w-110 block`,
      },
      {
        src: images.vector14,
        className: `${V} right-0 top-30 w-30 m:w-50 block`,
      },
      {
        src: images.vector15,
        className: `${V} left-0 -bottom-20 w-20 md:w-30 block`,
      },
      {
        src: images.vector16,
        className: `${V} right-0 bottom-0 w-24 hidden m:block`,
      },
  ...
  blog: {
    vectors: [
      ...
      {
        src: images.vector8,
        className: `${V} left-0 bottom-0 w-20 m:w-38 block`,
      },
      {
        src: images.vector9,
        className: `${V} right-0 top-10 m:-top-20 w-20 m:w-38 block`,
      },
    ],
  },
  "blog-detail": {
  ...
  activity: {
    vectors: [
      {
        src: images.vector18,
        className: `${V} left-0 top-40 w-40 m:w-60 block`,
      },
      {
        src: images.vector21,
        className: `${V} right-0 bottom-100 m:bottom-70 w-30 m:w-44 block`,
      },
      {
        src: images.vector20,
        className: `${V} left-0 bottom-0 m:bottom-40 w-50 block`,
      },
      {
        src: images.vector19,
        className: `${V} right-0 top-65 w-40 m:w-50 block`,
      },
    ],
  },
  "activity-detail": {
    ...
    vectors: [
      {
        src: images.vector18,
        className: `${V} left-0 top-50 w-40 hidden m:block`,
      },
      {
        src: images.vector19,
        className: `${V} right-0 bottom-50 w-44 hidden m:block`,
      },
    ],
  },
  service: {
    vectors: [
      ...
      {
        src: images.vector27,
        className: `${V} left-0 top-1/6 w-65 hidden m:block`,
      },
      {
        src: images.vector22,
        className: `${V} left-0 bottom-1/6 w-65 hidden m:block`,
      },
      {
        src: images.vector24,
        className: `${V} right-0 top-90 w-45 hidden m:block`,
      },
      {
        src: images.vector26,
        className: `${V} right-0 top-1/6 w-30 hidden m:block`,
      },
    ],
  },
  workshop: {
    ...
    vectors: [
      {
        src: images.vector25,
        className: `${V} left-0 top-40 w-30 md:w-50 block`,
      },
      {
        src: images.vector27,
        className: `${V} -left-10 top-1/6 w-60 block`,
      },
      {
        src: images.vector23,
        className: `${V} left-0 top-1/2 w-44 block`,
      },
      {
        src: images.vector27,
        className: `${V} -left-10 bottom-1/7 w-60 block`,
      },
      {
        src: images.vector24,
        className: `${V} right-0 top-40 w-30 md:w-50 block`,
      },
      {
        src: images.vector28,
        className: `${V} right-0 top-1/4 w-40 block`,
      },
      {
        src: images.vector24,
        className: `${V} right-0 bottom-50 w-40 block`,
      },
    ],
  },
};
      ...
      {!config.plain && config.showSideVectors && (
        <>
          <img
            ...
            aria-hidden
            alt=""
            className={`${V} right-0 -top-20 m:-top-40 w-20 m:w-44 block`}
          />
          <img
            src={images.vector1}
            aria-hidden
            alt=""
            className={`${V} right-0 top-1/2 w-30 block`}
          />
          <img
            src={images.vector2}
            aria-hidden
            alt=""
            className={`${V} left-0 top-20 w-44 block`}
          />
          <img
            src={images.vector4}
            aria-hidden
            alt=""
            className={`${V} left-0 bottom-1/3 w-35 block`}
          />
          <img
            src={images.vector3}
            aria-hidden
            alt=""
            className={`${V} left-1/6 h-1/2 -bottom-100 w-[90%] block`}
          />
        </>
      )}
