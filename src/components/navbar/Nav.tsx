...
const Nav = () => {
  ...
  return (
    ...
    >
      ...
      {isMobileMenuOpen && (
        <div className="m:hidden fixed inset-0  bg-black/30 px-6 py-6">
          <div className="ml-auto flex h-full w-full max-w-90 flex-col rounded-4xl bg-white p-6 z-9999 shadow-[0_20px_60px_rgba(0,0,0,0.18)]">
