...
const userContentList = [
  ...
  "ท่านให้สิทธิ์ MINDBLOOM CLINIC ในการใช้เนื้อหาดังกล่าวเพื่อปรับปรุงบริการ (ในรูปแบบไม่ระบุตัวตน)",
];
...
const miscList = [
  ...
  "การที่ MINDBLOOM CLINIC ไม่บังคับใช้สิทธิ์ใดๆ ไม่ถือเป็นการสละสิทธิ์นั้น",
  "ข้อกำหนดเหล่านี้ถือเป็นข้อตกลงทั้งหมดระหว่างท่านกับ MINDBLOOM CLINIC เกี่ยวกับการใช้งานเว็บไซต์",
];
    ...
    <div className="mt-14.75 w-full max-w-245 px-4 s:px-6 m:px-8 pb-24 flex flex-col">
      ...
      <section className="text-neutral-grey">
        ...
        <p className="rf-body indent-12">
          การเข้าถึงและใช้งานเว็บไซต์ MINDBLOOM CLINIC ("เว็บไซต์")
          ถือว่าท่านได้อ่าน เข้าใจ
          และยอมรับผูกพันตามข้อกำหนดและเงื่อนไขการใช้งานฉบับนี้ ("ข้อกำหนด")
          รวมถึงนโยบายความเป็นส่วนตัวของเรา หากท่านไม่ยอมรับข้อกำหนดเหล่านี้
      ...
      <section className="text-neutral-grey">
        ...
        <p className="rf-body indent-12">
          MINDBLOOM CLINIC
          เป็นคลินิกสุขภาพจิตที่ให้บริการดังต่อไปนี้ผ่านทางเว็บไซต์:
        </p>
      ...
      <section className="text-neutral-grey">
        ...
        <p className="rf-body indent-12">
          ...
          โลโก้ รูปภาพ วิดีโอ บทความ และซอฟต์แวร์ เป็นทรัพย์สินของ MINDBLOOM
          CLINIC และ/หรือผู้ให้ใช้สิทธิ์
      ...
      <section className="text-neutral-grey">
        ...
        <p className="rf-body indent-12">
          ...
          MINDBLOOM CLINIC ไม่รับผิดชอบต่อเนื้อหา ความถูกต้อง
      ...
      <section className="text-neutral-grey">
        ...
        <p className="rf-body indent-12">
          ในขอบเขตสูงสุดที่กฎหมายอนุญาต MINDBLOOM CLINIC จะไม่รับผิดชอบต่อ:
        </p>
        <ul className="rf-body mt-2 list-disc space-y-1 pl-15 text-neutral-grey marker:text-neutral-grey">
      ...
      <section className="text-neutral-grey">
        ...
        <p className="rf-body indent-12">
          ...
          ไม่ว่าโดยชัดแจ้งหรือโดยปริยาย MINDBLOOM CLINIC
      ...
      <section className="text-neutral-grey">
        ...
        <div className="rf-body mt-2 space-y-1 pl-12 text-neutral-grey">
          <p>MINDBLOOM CLINIC</p>
          {/* <p>อีเมล: [กรุณาระบุอีเมลติดต่อ]</p> */}
          <p>โทรศัพท์: +66 987654321</p>
          <p>
